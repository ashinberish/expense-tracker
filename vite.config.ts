...
const manifest: Partial<VitePWAOptions> = { 
  ...
  manifest: { 
      ...
      icons: [
          ...
          { src: "@/assets/logo/logo-180x180.png", sizes: "180x180", type: "image/png", purpose: "apple touch icon", }, 
          { src: "@/assets/logo/logo-225x225.png", sizes: "225x225", type: "image/png", purpose: "any maskable", },
      ], 
      theme_color: "#fff", 
